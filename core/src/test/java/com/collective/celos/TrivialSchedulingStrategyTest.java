...
public class TrivialSchedulingStrategyTest {
    ...
    public void trivialSchedulingWorks() {
        ...
        SlotID slot1 = new SlotID(workflow, new ScheduledTimeImpl("2013-11-18T20:00Z"));
        SlotState state1 = new SlotState(slot1, SlotState.Status.READY);
        states.add(state1);
        
        SlotID slot2 = new SlotID(workflow, new ScheduledTimeImpl("2013-11-18T21:00Z"));
        SlotState state2 = new SlotState(slot2, SlotState.Status.WAITING);
        states.add(state2);
        
        SlotID slot3 = new SlotID(workflow, new ScheduledTimeImpl("2013-11-18T22:00Z"));
        SlotState state3 = new SlotState(slot3, SlotState.Status.RUNNING);
        states.add(state3);
        
        SlotID slot4 = new SlotID(workflow, new ScheduledTimeImpl("2013-11-18T23:00Z"));
        SlotState state4 = new SlotState(slot4, SlotState.Status.READY);
        states.add(state4);
        
        SlotID slot5 = new SlotID(workflow, new ScheduledTimeImpl("2013-11-19T00:00Z"));
