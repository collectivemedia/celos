...
public class ScheduledTimeTest {
    ...
    public void scheduledTimeCompareToWorks() {
        ScheduledTime t1 = new ScheduledTimeImpl("2013-11-26T13:00Z");
        ScheduledTime t2 = new ScheduledTimeImpl("2013-11-26T13:01Z");
    ...
    public void testGetYear() {
        ScheduledTime t = new ScheduledTimeImpl("2013-11-18T20:00Z");
    ...
    public void testGetMinute() {
        ScheduledTime t = new ScheduledTimeImpl("2013-11-18T20:12Z");
        assertEquals(12, t.getMinute());
    }
    
    @Test
    public void testGetSecond() {
        ScheduledTime t = new ScheduledTimeImpl("2013-11-18T20:12:53Z");
        assertEquals(53, t.getSecond());
    }
    
    @Test
    public void testGetMillisecond() {
        ScheduledTime t = new ScheduledTimeImpl("2013-11-18T20:12:53.023Z");
