...
ansible-playbook scripts/celos-deploy.yaml -u celos-ci -i scripts/conf/inventory-testing-ui -e service_version=${GIT_COMMIT} -e "@scripts/conf/integration-params.json" -e "@scripts/conf/common-params-ui.json"
