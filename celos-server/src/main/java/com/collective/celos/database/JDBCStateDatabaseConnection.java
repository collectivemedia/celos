...
public class JDBCStateDatabaseConnection implements StateDatabaseConnection {
    ...
    private static final Logger LOGGER = Logger.getLogger(JDBCStateDatabaseConnection.class);

    private final Connection connection;

    public JDBCStateDatabaseConnection(Config config) throws SQLException {
        this.connection = DriverManager.getConnection(config.url, config.name, config.password);
    }
