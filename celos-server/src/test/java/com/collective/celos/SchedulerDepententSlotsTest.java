...
public class SchedulerDepententSlotsTest {
    ...
    public void testUpstreamFindDependentSlotsDifferentSchedule() throws Exception {
        ...
        Assert.assertEquals(idSet5, Sets.newHashSet(id1, id4, id5, id6));
    ...
    public void testDownstreamFindDependentSlotsSameSchedule() throws Exception {
        ...
        Assert.assertEquals(Sets.newHashSet(id2, id3, id5, id8, id9), scheduler.getDownstreamSlots(id1));
        Assert.assertEquals(Sets.newHashSet(id3, id8, id9), scheduler.getDownstreamSlots(id2));
        Assert.assertEquals(Sets.newHashSet(id8, id9), scheduler.getDownstreamSlots(id3));
