...
public class HDFSCheckTriggerTest {
    ...
    public void testDirectoryExists() throws Exception {
        assertTrue(new HDFSCheckTrigger("/tmp", "file:///").isDataAvailable(scheduler, Util.zonedDateTimeNowUTC(), ZonedDateTime.parse("2013-11-22T15:00Z")));
    }

    @Test
    public void testDirectoryDoesNotExist() throws Exception {
        assertFalse(new HDFSCheckTrigger("/tmp-does-not-exist", "file:///").isDataAvailable(scheduler, Util.zonedDateTimeNowUTC(), ZonedDateTime.parse("2013-11-22T15:00Z")));
    }
    ...
    public void testFileExists() throws Exception {
        ...
        assertTrue(new HDFSCheckTrigger(root + "/${year}-${month}-${day}/${hour}00/_READY",  "file:///").isDataAvailable(scheduler, Util.zonedDateTimeNowUTC(), ZonedDateTime.parse("2013-11-22T15:00Z")));
    }
    ...
    public void testFileDoesNotExist() throws Exception {
        ...
        assertFalse(new HDFSCheckTrigger(root + "/${year}-${month}-${day}/${hour}00/_READY", "file:///").isDataAvailable(scheduler, Util.zonedDateTimeNowUTC(), ZonedDateTime.parse("2013-11-22T15:00Z")));
    }
    ...
    public void testIOExceptionIsPropagated() throws Exception {
        new HDFSCheckTrigger("/some/path", "hdfs://no-such-host").isDataAvailable(scheduler, Util.zonedDateTimeNowUTC(), ZonedDateTime.parse("2013-11-22T15:00Z"));
    }
