...
public class JavaScriptFunctionsTest {
    ...
    public void testCronScheduleRequiresExpr() throws Exception {
        expectMessage("celos.cronSchedule()", "Undefined cron expression (celos-scripts.js#91)");
    }
    ...
    public void testHDFSCheckTriggerRequiresPath() {
        expectMessage("celos.hdfsCheckTrigger()", "Undefined path in hdfsCheckTrigger (celos-scripts.js#126)");
    }

    @Test
    public void testHDFSCheckTriggerRequiresFs() {
        expectMessage("celos.hdfsCheckTrigger('/foo')", "Undefined fs in hdfsCheckTrigger and CELOS_DEFAULT_HDFS not set (celos-scripts.js#132)");
    }
    ...
    public void testNotTriggerRequiresSubTrigger() throws Exception {
        expectMessage("celos.notTrigger()", "Undefined sub trigger (celos-scripts.js#156)");
    }
    ...
    public void testOffsetTriggerRequiresSeconds() throws Exception {
        expectMessage("celos.offsetTrigger()", "Undefined seconds (celos-scripts.js#170)");
    }

    @Test
    public void testOffsetTriggerRequiresSecondsAndTrigger() throws Exception {
        expectMessage("celos.offsetTrigger(25)", "Undefined trigger (celos-scripts.js#173)");
    }
    ...
    public void testDelayTriggerRequiresSeconds() throws Exception {
        expectMessage("celos.delayTrigger()", "Undefined seconds (celos-scripts.js#163)");
    }
    ...
    public void testSuccessTriggerRequiresWorkflowName() throws Exception {
        expectMessage("celos.successTrigger()", "Undefined workflow name in success trigger (celos-scripts.js#180)");
    }
    ...
    public void testOozieURLRequired() throws Exception {
        expectMessage("celos.oozieExternalService({bla:'hello'})", "Undefined Oozie URL (celos-scripts.js#232)");
    }
