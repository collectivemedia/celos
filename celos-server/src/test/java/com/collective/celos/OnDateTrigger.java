...
public class OnDateTrigger extends Trigger {
    ...
    public OnDateTrigger(String scheduledTime) {
        this(ZonedDateTime.parse(scheduledTime));
    }

    public OnDateTrigger(ZonedDateTime scheduledTime) {
        this.scheduledTime = scheduledTime;
    }


    @Override
    public TriggerStatus getTriggerStatus(Scheduler scheduler, ZonedDateTime now, ZonedDateTime time) throws Exception {
