...
public class RerunStateTest {
    ...
    public void testExpiration() {
        ...
        Assert.assertTrue(st.isExpired(ZonedDateTime.parse("2015-10-07T00:00Z")));
        Assert.assertFalse(st.isExpired(ZonedDateTime.parse("2015-09-14T00:00Z")));
        Assert.assertFalse(st.isExpired(ZonedDateTime.parse("2014-09-14T00:00Z")));
    }
