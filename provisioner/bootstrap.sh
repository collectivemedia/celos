...
ansible-playbook -i tmp/inventory -u ubuntu site.yaml  -f 4 --skip-tags=oozie,yarn,hive 
ansible-playbook -i tmp/inventory -u ubuntu site.yaml  -f 4 -t oozie,yarn,hive 
