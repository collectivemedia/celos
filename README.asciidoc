...
The String value of this variable will be used as the default HDFS name node URI.

==== CELOS_DEFAULT_OOZIE

The String value of this variable will be used as the default Oozie API URL.

==== CELOS_DEFAULT_OOZIE_PROPERTIES

The members of this Object will be added to the Oozie properties of a workflow.
