...
* celos-server/build/libs/celos-server.jar
* celos-ci/build/libs/celos-ci-fat.jar
* celos-ui/build/libs/celos-ui.jar

See link:samples/quickstart[] for examples of how to launch the JARs.
