...
public class WorkflowFileDeployerTest {
    ...
    public void testGetWorkflowJsUri1() throws FileSystemException, URISyntaxException {
        ...
        CelosCiTarget target = new CelosCiTarget(URI.create(""), URI.create(""), URI.create(""), URI.create(""), URI.create("hiveJdbc"));
    ...
    public void testGetWorkflowJsUri2() throws FileSystemException, URISyntaxException {
        ...
        CelosCiTarget target = new CelosCiTarget(URI.create(""), URI.create(""), URI.create("/home"), URI.create(""), URI.create("hiveJdbc"));
        doReturn(target).when(context).getTarget();
        doReturn("workflow").when(context).getWorkflowName();
    ...
    public void testGetWorkflowJsUri3() throws FileSystemException, URISyntaxException {
        ...
        CelosCiTarget target = new CelosCiTarget(URI.create(""), URI.create(""), URI.create("sftp://user@server:999/home"), URI.create(""), URI.create("hiveJdbc"));
        doReturn(target).when(context).getTarget();
        doReturn("workflow").when(context).getWorkflowName();
    ...
    public void testDeploy() throws Exception {
        ...
        CelosCiTarget target = new CelosCiTarget(URI.create(""), URI.create(""), remoteFolder.toURI(), URI.create(""), URI.create("hiveJdbc"));
        doReturn(localFolder).when(context).getDeployDir();
        doReturn(target).when(context).getTarget();
        doReturn("workflow").when(context).getWorkflowName();
