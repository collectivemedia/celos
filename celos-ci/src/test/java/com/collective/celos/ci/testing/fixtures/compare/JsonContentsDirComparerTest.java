...
public class JsonContentsDirComparerTest {
    ...
    public void testJsonContentsDirComparerOK() throws Exception {
        ...
        JsonContentsDirComparer dirComparer = new JsonContentsDirComparer(Collections.EMPTY_SET, content, fixDir1);
    ...
    public void testJsonContentsDirComparerOKIgnorePaths() throws Exception {
        ...
        FixDirFromResourceCreator creator = new FixDirFromResourceCreator(new File("/"), dir1.getAbsolutePath());
        FixDir fixDir1 = creator.create(null).asDir();
        JsonContentsDirComparer dirComparer = new JsonContentsDirComparer(ignorePaths, content, fixDir1);
    ...
    public void testJsonContentsDirComparerFailContent() throws Exception {
        ...
        FixDirFromResourceCreator creator = new FixDirFromResourceCreator(new File("/"), dir1.getAbsolutePath());
        FixDir fixDir1 = creator.create(null).asDir();
        JsonContentsDirComparer dirComparer = new JsonContentsDirComparer(Collections.EMPTY_SET, is, fixDir1);
