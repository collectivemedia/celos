package com.collective.celos.ci.fixture.util;
...
public class AvroJsonConverterTest {
    ...
    public void testAvroHelper() throws IOException, URISyntaxException {
        ...
        InputStream inputJson = Thread.currentThread().getContextClassLoader().getResourceAsStream("com/collective/celos/ci/fixtures/avro/avro.json");
