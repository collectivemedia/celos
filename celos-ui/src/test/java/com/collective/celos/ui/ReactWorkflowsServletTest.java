...
import com.collective.celos.old.UIServlet;
...
public class ReactWorkflowsServletTest {
    ...
    private final WorkflowGroupsServlet workflowGroupsServlet = new WorkflowGroupsServlet();

    @Test
    public void processWorkflowGroupTest() throws Exception {
        ...
        Assert.assertEquals(Util.MAPPER.readTree(check), Util.MAPPER.readTree(Util.MAPPER.writeValueAsString(xx)));
