...
public class Configuration {
    ...
    public Configuration(ScheduledTime start, ScheduledTime end, NavigableSet<ScheduledTime> tileTimes,
                         List<WorkflowGroup> groups, Map<WorkflowID, WorkflowStatus> statuses, URL hueURL) {
